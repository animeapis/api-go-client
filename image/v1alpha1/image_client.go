...
// NewRESTClient creates a new image rest client.
...
func (c *gRPCClient) ListAlbums(ctx context.Context, req *imagepb.ListAlbumsRequest, opts ...gax.CallOption) *AlbumIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*imagepb.Album, string, error) {
		resp := &imagepb.ListAlbumsResponse{}
		if pageToken != "" {
...
// UploadImage uploads an image through the request HttpBody.
func (c *restClient) UploadImage(ctx context.Context, req *imagepb.UploadImageRequest, opts ...gax.CallOption) (*imagepb.UploadImageResponse, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha1/%v/images:upload", req.GetParent())
	...
	resp := &imagepb.UploadImageResponse{}
...
// ImportImage imports an image from a remote web address.
func (c *restClient) ImportImage(ctx context.Context, req *imagepb.ImportImageRequest, opts ...gax.CallOption) (*imagepb.ImportImageResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha1/%v/images:import", req.GetParent())
	...
	opts = append((*c.CallOptions).ImportImage[0:len((*c.CallOptions).ImportImage):len((*c.CallOptions).ImportImage)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &imagepb.ImportImageResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// GetImage gets an image in binary representation with the format and size requested.
func (c *restClient) GetImage(ctx context.Context, req *imagepb.GetImageRequest, opts ...gax.CallOption) (*httpbodypb.HttpBody, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	params := url.Values{}
	if req.GetBlur() {
		params.Add("blur", fmt.Sprintf("%v", req.GetBlur()))
	}
	if req.GetContentType() != "" {
		params.Add("contentType", fmt.Sprintf("%v", req.GetContentType()))
	}
	if req.GetResize().GetHeight() != 0 {
		params.Add("resize.height", fmt.Sprintf("%v", req.GetResize().GetHeight()))
	}
	if req.GetResize().GetWidth() != 0 {
		params.Add("resize.width", fmt.Sprintf("%v", req.GetResize().GetWidth()))
	}
...
// GetAlbum gets an image album.
func (c *restClient) GetAlbum(ctx context.Context, req *imagepb.GetAlbumRequest, opts ...gax.CallOption) (*imagepb.Album, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// ListAlbums lists image albums with pagination.
func (c *restClient) ListAlbums(ctx context.Context, req *imagepb.ListAlbumsRequest, opts ...gax.CallOption) *AlbumIterator {
	it := &AlbumIterator{}
	req = proto.Clone(req).(*imagepb.ListAlbumsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*imagepb.Album, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1alpha1/%v/albums", req.GetParent())
...
// CreateAlbum creates a new image album.
func (c *restClient) CreateAlbum(ctx context.Context, req *imagepb.CreateAlbumRequest, opts ...gax.CallOption) (*imagepb.Album, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
// DeleteAlbum deletes an existing image album.
func (c *restClient) DeleteAlbum(ctx context.Context, req *imagepb.DeleteAlbumRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// GetAlbumSettings gets the settings of an image album.
func (c *restClient) GetAlbumSettings(ctx context.Context, req *imagepb.GetAlbumSettingsRequest, opts ...gax.CallOption) (*imagepb.AlbumSettings, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
...
// UpdateAlbumSettings updates the settings of an image album.
func (c *restClient) UpdateAlbumSettings(ctx context.Context, req *imagepb.UpdateAlbumSettingsRequest, opts ...gax.CallOption) (*imagepb.AlbumSettings, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
