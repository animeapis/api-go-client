...
func (c *gRPCClient) ListRepositories(ctx context.Context, req *hubpb.ListRepositoriesRequest, opts ...gax.CallOption) *RepositoryIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*hubpb.Repository, string, error) {
		resp := &hubpb.ListRepositoriesResponse{}
		if pageToken != "" {
...
func (c *restClient) CreateRepository(ctx context.Context, req *hubpb.CreateRepositoryRequest, opts ...gax.CallOption) (*hubpb.Repository, error) {
...
func (c *restClient) DeleteRepository(ctx context.Context, req *hubpb.DeleteRepositoryRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
func (c *restClient) ListRepositories(ctx context.Context, req *hubpb.ListRepositoriesRequest, opts ...gax.CallOption) *RepositoryIterator {
	it := &RepositoryIterator{}
	req = proto.Clone(req).(*hubpb.ListRepositoriesRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*hubpb.Repository, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v1alpha1/%v/repositories", req.GetParent())
