...
// internalChapterClient is an interface that defines the methods available from Multimedia API.
...
func (c *chapterRESTClient) GetChapter(ctx context.Context, req *multimediapb.GetChapterRequest, opts ...gax.CallOption) (*multimediapb.Chapter, error) {
...
func (c *chapterRESTClient) ListChapters(ctx context.Context, req *multimediapb.ListChaptersRequest, opts ...gax.CallOption) *ChapterIterator {
	it := &ChapterIterator{}
	req = proto.Clone(req).(*multimediapb.ListChaptersRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*multimediapb.Chapter, string, error) {
...
func (c *chapterRESTClient) CreateChapter(ctx context.Context, req *multimediapb.CreateChapterRequest, opts ...gax.CallOption) (*multimediapb.Chapter, error) {
...
func (c *chapterRESTClient) BatchCreateChapters(ctx context.Context, req *multimediapb.BatchCreateChaptersRequest, opts ...gax.CallOption) (*BatchCreateChaptersOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha1/%v/chapters:batchCreate", req.GetParent())
...
func (c *chapterRESTClient) UpdateChapter(ctx context.Context, req *multimediapb.UpdateChapterRequest, opts ...gax.CallOption) (*multimediapb.Chapter, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
func (c *chapterRESTClient) DeleteChapter(ctx context.Context, req *multimediapb.DeleteChapterRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
...
// ReconcileChapters reconcile chapters with the search and knowledge base.
func (c *chapterRESTClient) ReconcileChapters(ctx context.Context, req *multimediapb.ReconcileChaptersRequest, opts ...gax.CallOption) (*ReconcileChaptersOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1alpha1/%v/chapters:reconcile", req.GetParent())
...
// BatchCreateChaptersOperation returns a new BatchCreateChaptersOperation from a given name.
// The name must be that of a previously created BatchCreateChaptersOperation, possibly from a different process.
func (c *chapterRESTClient) BatchCreateChaptersOperation(name string) *BatchCreateChaptersOperation {
...
// ReconcileChaptersOperation returns a new ReconcileChaptersOperation from a given name.
// The name must be that of a previously created ReconcileChaptersOperation, possibly from a different process.
func (c *chapterRESTClient) ReconcileChaptersOperation(name string) *ReconcileChaptersOperation {
	override := fmt.Sprintf("/v1alpha1/%s", name)
	return &ReconcileChaptersOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
